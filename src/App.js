...
const App = () => {
  ...
  return (
      ...
      {sh > ch ? (
        ...
        <Sidebar />
          <ToDoList style={{ backgroundColor: "rgba(255, 255, 255, 0.6)" }} data-aos="fade-up"/>
        {/* <Card style={{width: "70%", marginLeft: "15%" , display: "none"}} data-aos="fade-up"> */}
          <Row style={{ backgroundColor: "rgba(255, 255, 255, 0.6)", width: "70%", marginLeft: "15%"}}>
          <Col >
            <Fan />
          </Col>
          <Col>
        ...
        <Row data-aos="fade-right" style={{}}>
          ...
          <Row style={{ width: "80%", marginLeft: "10%", height: '20%'}} data-aos="fade-left">
            <ToDoList data-aos="fade-right"/>
          </Row>
          <Row style={{ height: "4%", width: "54%", marginLeft: "23%", backgroundColor: "rgba(255, 255, 255, 0.6)"}} data-aos="fade-up">
            <Col>
              <Fan />
            </Col>
            <Col>
